...
export function App() {
  ...
  const stateLabel = {idle:'Listo para comenzar',running:'Sesión en curso',paused:'Sesión en pausa',cancelled:'Sesión finalizada',complete:'Sesión completada'}[session.status];
