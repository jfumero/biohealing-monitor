...
function ensureAudio(){
  ...
  masterGain.gain.value = 0.06;             // volumen maestro audible
...
function startHum(){
  ...
  humOsc.type='sawtooth'; humOsc.frequency.value=220;
...
async function resumeAudio(){ ensureAudio(); try{ await audioCtx.resume(); }catch{} }
...
// Escala 0–100: ticks y números negros pegados al borde interior
function buildTicks(){
...
function createCard(mod){
  ...
  // Valor inicial aleatorio entre 35 y 70 para no “nacer” en 0
...
// Defaults si esperan en bienvenida
